...
def main_worker(gpu, ngpus_per_node, args):
    ...
    scheduler = get_cosine_schedule_with_warmup(optimizer,
                                                args.epoch*args.num_train_iter,
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str, default='pimodel')
    ...
    parser.add_argument('--num_train_iter', type=int, default=120,
                        help='total number of training iterations')
    parser.add_argument('--num_eval_iter', type=int, default=120,
                        help='evaluation frequency')
    parser.add_argument('--unsup_warmup_pos', type=float, default=0.2,
                        help='Relative position at which constraint loss warmup ends.')
    
    parser.add_argument('-nl', '--num_labels', type=float, default=40)
    ...
    parser.add_argument('-ds', '--dataset', type=str, default='uci')
